...
namespace HoloToolkit.Unity
{
    ...
    public partial class GazeManager : Singleton<GazeManager>
    {
        ...
        private float lastHitDistance = 5.0f;
        ...
        private void Update()
        {
            ...
            //Check if the raycast hit a hologram
            UpdateRaycast();
        ...
        private void UpdateRaycast()
        {
            ...
            RaycastHit hitInfo;
            Hit = Physics.Raycast(headPosition,
                           gazeDirection,
                           out hitInfo,
                           MaxGazeDistance,
                           RaycastLayerMask);
        ...
        private void UpdateStabilizationPlane()
        {
            if (SetStabilizationPlane)
            {
                ...
                float focusPointDistance = (headPosition - Position).magnitude;
                ...
                Vector3 newFocusPointPosition = headPosition + (gazeDirection * lastHitDistance);
